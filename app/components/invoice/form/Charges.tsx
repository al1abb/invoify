    ...
    <>
      ...
      <div className="flex flex-col gap-3 min-w-[20rem]">
        ...
        <div className="flex justify-evenly pb-6">
          <div>
            <Label>{_t("form.steps.summary.advancePayment")}</Label>

            <div>
              <div>
                <Switch
                  checked={advancePaymentSwitch}
                  onCheckedChange={(value) => {
                    setAdvancePaymentSwitch(value);
                  }}
                />
              </div>
            </div>
        ...
        <div className="flex flex-col justify-center px-5 gap-y-3">
          ...
          {advancePaymentSwitch && (
            <ChargeInput
              label={_t("form.steps.summary.advancePayment")}
              name="details.advancePaymentDetails.amount"
              switchAmountType={switchAmountType}
              type={advancePaymentType}
              setType={setAdvancePaymentType}
              currency={currency}
            />
          )}

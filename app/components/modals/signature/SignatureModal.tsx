                    ...
                    <div>
                        ...
                        {signature && isDataUrl(signature) ? (
                            ...
                            <div
                                ...
                                className="flex flex-col justify-center items-center h-[155px] rounded-md bg-gray-50 dark:bg-slate-800 border border-black dark:border-white hover:border-blue-500"
                            >
                                <FileSignature />
                                <Label>
                                    {_t(

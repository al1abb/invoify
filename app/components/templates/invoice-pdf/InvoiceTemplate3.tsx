...
const InvoiceTemplate3 = (data: InvoiceType) => {
    ...
    // Removed manual pagination; we will rely on print CSS to paginate the table
    ...
    return (
        <InvoiceLayout data={data}>
            ...
            {/* Goods table: single table that can span pages; header repeats automatically */}
            ...
            {/* Totals row and summaries strictly after full items table */}

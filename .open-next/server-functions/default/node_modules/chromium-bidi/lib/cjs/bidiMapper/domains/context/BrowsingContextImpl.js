...
class BrowsingContextImpl {
    ...
    async toggleModulesIfNeeded() {
        const enableNetwork = this.#eventManager.subscriptionManager.isSubscribedTo(chromium_bidi_js_1.BiDiModule.Network, this.id);
    ...
    async locateNodes(params) {
        ...
        if (params.maxNodeCount !== undefined) {
            // TODO: implement.
            throw new protocol_js_1.UnsupportedOperationException(`maxNodeCount is not supported`);
        }
        if (params.serializationOptions !== undefined) {
            // TODO: implement.
            throw new protocol_js_1.UnsupportedOperationException(`serializationOptions is not supported`);
        }
    ...
    #getLocatorFunction(locator) {
        switch (locator.type) {
            ...
            default:
                throw new protocol_js_1.UnsupportedOperationException(`locateNodes does not support ${locator.type} locator type.`);
        }
    }
